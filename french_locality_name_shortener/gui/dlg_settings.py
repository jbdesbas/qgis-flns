...
# project
from french_locality_name_shortener.__about__ import (
    DIR_PLUGIN_ROOT,
    __icon_path__,
    __title__,
    __uri_homepage__,
...
from french_locality_name_shortener.toolbelt import PlgLogger, PlgOptionsManager
from french_locality_name_shortener.toolbelt.preferences import PlgSettingsStructure
