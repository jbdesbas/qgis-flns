...
# project
from french_locality_name_shortener.__about__ import DIR_PLUGIN_ROOT, __version__
...
class FrenchLocalityNameShortenerProvider(QgsProcessingProvider):
    """
    ...
    def id(self) -> str:
        ...
        :rtype: str
        """
        return "french_locality_name_shortener"
    ...
    def name(self) -> str:
        ...
        :rtype: str
        """
        return self.tr("FrenchLocalityNameShortener")
    ...
    def longName(self) -> str:
        ...
        :rtype: str
        """
        return self.tr("French Locality Name Shortener - Tools")
